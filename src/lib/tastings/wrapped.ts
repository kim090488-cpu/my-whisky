...
/** month 형식: "YYYY-MM". 유효하지 않으면 null. */
...
export async function loadWrappedMonth(
  ...
  // 가장 좋아요 많이 받은 노트 (like_count > 0인 것 중 top 1)
  ...
  // 새로 만난 bottling — 이번 달 이전 시음 이력이 없는 것들
